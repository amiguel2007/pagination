...
$statementt = $db_con->prepare("select * from mock_data where id > :id");
$statementt->execute(array(':id' => 0));
//$statement::rowCount();
...
$statement = $db_con->prepare("select * from mock_data ORDER BY id ASC LIMIT $start_from, $limit");
$statement->execute();
